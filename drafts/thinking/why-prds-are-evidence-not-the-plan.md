...
1. What user signal prompted the work.
2. What customer or market evidence was reviewed.
3. What assumptions are still unproven.
4. What constraints shape the solution.
5. What decision is needed from a human.
6. What would cause the team to change direction.
